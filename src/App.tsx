...
const buttonPress = (symbol: string) =>{
  if(symbol === "clear"){
    ...
    setExpresion (et + " " + symbol + " ");
  } else if (symbol === "="){ 
    calculate();}
    else if ( symbol === "0"){
    if(expression.charAt(0) !== "0"){
      setExpresion(expression + symbol);
    }
  } else if (symbol === ".") {
    ...
    setExpresion(expression + symbol);
      ...
      setExpresion(expression.slice(1) + symbol);}
      else{
      setExpresion(expression + symbol);
    } 
  }
...
for (let i = parts.length - 1; i >= 0; i--) {
  ...
  <div className= "container">
    ...
    <div id="calculator">
      ...
      <button id= "clear" onClick={() => buttonPress("clear")}className="light-red">AC</button>
      <button id= "negative" onClick={() => buttonPress("negtive")}className="light-gray">+/-</button>
      ...
      <button id= "multiply" onClick={() => buttonPress("*")}className="blue">*</button>
